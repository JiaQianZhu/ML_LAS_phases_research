...
Author:JiaQian Zhu
Date:2023-8-17
Usage:This module offers method to test the generalization ability of best-performing model.
"""
import pandas as pd
import pickle

df = pd.read_csv('data/data_generalization_test.csv', index_col=False)
...
result.to_csv('predicted_crystals.csv', index=False)
